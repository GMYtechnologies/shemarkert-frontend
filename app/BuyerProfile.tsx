...
export default function BuyerProfile({ user, onBack }: BuyerProfileProps) {
  ...
  const [profileData, setProfileData] = useState({
    ...
    profileImage: 'https://images.unsplash.com/photo-1494790108755-2616b332c6db?w=150&h=150&fit=crop&crop=face'
  });
  ...
  const likedProducts = [
    ...
    },
    {
      ...
      price: 800000,
      image: 'https://images.unsplash.com/photo-1594736797933-d0d2d19b2d10?w=200&h=250&fit=crop',
